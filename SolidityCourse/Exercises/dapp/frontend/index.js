const addressContract = "0xf143791f766565800f8e435b46aff531a23ef4d1";
...
function init() {
    if (typeof window.ethereum !== 'undefined') {
        ...
        metamaskBtn.addEventListener('click', async () => {
            ...
            detectChangeAccount();
            contract();
            document.getElementById('login').style.display = 'none'; document.getElementById('main').classList.remove('d-none');
